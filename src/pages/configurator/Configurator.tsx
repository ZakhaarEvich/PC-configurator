        ...
        <div>
            <Section className="md:px-6 py-6">
             ...
             <Section className="md:px-6 md:py-6"> 
                <h1 className="text-3xl font-play text-app-dark">Есть вопросы по выбору железа?</h1>
                <p className="text-gray-700 mt-1.5 mb-5">Спросите меня лично через Telegram и получите ответ в течение
